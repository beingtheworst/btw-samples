...
namespace E014.Domain
{
    ...
    /// This helper object allows you to take two .NET objects and get a human readable difference between their states.  This provides member-by-member comparisons
    /// to assist us in making decisions to determine what action to take if there is a difference.  This alternative to a straight binary comparison of objects gives
    /// us the opportunity to understand what changed between event properties and take meaningful action and/or speed up debugging of issues.
    /// Source code was provided by http://comparenetobjects.codeplex.com/
